...
my_data = genfromtxt('surv_birth_vary_c_factor_10_sc_0.txt', delimiter=',')
...
################################ Short - bactericidal
my_data = genfromtxt('surv_birth_vary_c_factor_10_sc_1.txt', delimiter=',')
...
plt.plot(c_data1,data1,'^',color='C0',markersize=10)
plt.semilogx(c,surv_bc,linewidth=3)
plt.plot(c_data2,data2,'^',color='C1',markersize=10)
plt.vlines(c[170],0,.75,linestyle='dashed',color='black',lw=2)
