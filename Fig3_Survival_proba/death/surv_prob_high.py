...
################################ biostatic
my_data = genfromtxt('surv_death_vary_c_fac_20_sc_0.txt', delimiter=',')
...
################################ biocidic
my_data = genfromtxt('surv_death_vary_c_fac_20_sc_1.txt', delimiter=',')
...
plt.vlines(c[170],0,.58,linestyle='dashed',color='black',lw=2)
