...
my_data = genfromtxt('surv_birth_vary_c_factor_5_sc_0.txt', delimiter=',')
...
################################ Short - bactericidal
my_data = genfromtxt('surv_birth_vary_c_factor_5_sc_1.txt', delimiter=',')
...
################################ Plot surv prob
################################
plt.semilogx(c_data1,data1,'s',color='C0',markersize=10)
plt.vlines(c[170],0,.975,linestyle='dashed',color='black',lw =2)
