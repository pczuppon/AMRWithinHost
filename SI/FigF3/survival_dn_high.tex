...
\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{birth_low}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
			...
			\draw[thick,color=py_blue] (0.15,0.3) -- node[right=5pt] {\color{black} biostatic} (0.2,0.3);        	
			\draw[thick,color=py_orange] (0.15,0.2) -- node[right=5pt] {\color{black} biocidal} (0.2,0.2);    
