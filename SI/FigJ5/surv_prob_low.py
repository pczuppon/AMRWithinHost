...
my_data = genfromtxt('survIR_day_vary_c_factor_0.45.txt', delimiter=',')
...
################################ Short - bacteriostatic
my_data = genfromtxt('survIR_day_vary_c_factor_0.45_alt.txt', delimiter=',')
...
plt.semilogy(c_data2,data2,'s',color='C1',markersize=10)
