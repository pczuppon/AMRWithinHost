...
\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{ct_birth_low}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
   			\node (Bild2) at ([xshift=2.75cm]Bild.east) {\includegraphics[scale=0.39]{ct_birth_inter}};
   			\node (B3) at ([xshift=2.75cm]Bild2.east) {\includegraphics[scale=.39]{ct_birth_high}};
        	
			%\node (B4) at ([yshift=-2.25cm]Bild.south) {\includegraphics[scale=.39]{ct_death_det_low}};
			%\node (B5) at ([xshift=2.75cm]B4.east) {\includegraphics[scale=0.39]{ct_death_det_inter}};
   			%\node (B6) at ([xshift=2.75cm]B5.east) {\includegraphics[scale=.39]{ct_death_det_high}};        	
        	
        	\node at ([yshift=-.2cm]Bild2.south) {\Large antibiotic concentration $c$};
        	\node[rotate=90] at ([xshift=-.4cm,yshift=-0.2cm]Bild.west) {\Large mean carriage time};
...
%        	\node at ([yshift=.5cm,xshift=.5cm]B6.east) {\Large density};
 %       	\node at ([yshift=0cm,xshift=.5cm]B6.east) {\Large affects};
  %      	\node at ([yshift=-.5cm,xshift=.5cm]B6.east) {\Large death};
			...
			\node at ([xshift=0.75cm,yshift=1.65cm]Bild.center) {\small mic$_S$};   
