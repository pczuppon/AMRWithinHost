...
\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{ct_birth_low}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
			...
			\node (B4) at ([yshift=-2.25cm]Bild.south) {\includegraphics[scale=.39]{ct_death_low}};
			\node (B5) at ([xshift=2.75cm]B4.east) {\includegraphics[scale=0.39]{ct_death_inter}};
   			\node (B6) at ([xshift=2.75cm]B5.east) {\includegraphics[scale=.39]{ct_death_high}};        	
			...
			\node at ([xshift=0.75cm,yshift=1.6cm]Bild.center) {\small mic$_S$};   
