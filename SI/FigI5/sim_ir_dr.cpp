...
// g++ -std=c++11 sim_ir_dr.cpp `pkg-config --libs gsl` command for compiling
...
int main(int argc,char *argv[])
{
    ...
    ofstream file ("survIR_day_vary_c_factor_" + std::to_string(hR) + ".txt", ios::app);   // file output, average
    file << c;
    file << ",";
    file << avg;  
    file << "\n";
