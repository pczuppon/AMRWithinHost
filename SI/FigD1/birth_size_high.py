...
for i in range(len(c)):
    ...
    size_bs_nosmooth.append(xR)
    size_bs_surv.append(xR_surv)
...
for i in range(len(c)):
    ...
    size_bc_nosmooth.append(xR)
    size_bc_surv.append(xR_surv)
...
plt.semilogx(c,size_bs_surv,color='C0',linewidth=3,linestyle='dotted')
#plt.semilogx(c,size_bc_surv,color='C1',linewidth=3,linestyle='dotted')
plt.plot(c,size_bs_nosmooth,color='C0',linewidth=3,linestyle='dashed')
#plt.plot(c,size_bc_nosmooth,color='C1',linewidth=3,linestyle='dashed')
