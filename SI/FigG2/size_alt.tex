...
\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{birth_low_blank}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
			...
			\node (B5) at ([xshift=2.75cm]B4.east) {\includegraphics[scale=0.39]{death_inter_blank}};
        	...
        	\node[rotate=90] at ([xshift=-.7cm,yshift=-2.45cm]Bild.west) {\Large number resistant individuals};
