...
// g++ -std=c++11 sim_ext_times_birth.cpp `pkg-config --libs gsl` command for compiling
...
int main(int argc,char *argv[])
{
    ...
    ofstream file ("ext_time_birth_c_" + std::to_string(c) + "_fac_" + std::to_string((int)fac) + "_sc_" + std::to_string(scenario) + ".txt", ios::app);   // file output, average
