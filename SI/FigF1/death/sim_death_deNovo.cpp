...
// g++ -std=c++11 sim_death_deNovo.cpp `pkg-config --libs gsl` command for compiling
...
int main(int argc,char *argv[])
{
    ...
    ofstream file ("surv_death_denovo_fac_" + std::to_string(fac2) + "_sc_" + std::to_string(scenario) + ".txt", ios::app);   // file output, average
    file << c;
    file << ",";
    file << avg;  
    file << "\n";
