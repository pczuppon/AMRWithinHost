...
\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (Bild) at (0,0) {\includegraphics[scale=0.39]{birth_low}};
   		\begin{scope}[x=(Bild.south east),y=(Bild.north west)]
   			\node (Bild2) at ([xshift=2.75cm]Bild.east) {\includegraphics[scale=0.39]{birth_inter}};
   			\node (B3) at ([xshift=2.75cm]Bild2.east) {\includegraphics[scale=.39]{birth_high}};
        	
			\node (B4) at ([yshift=-2.25cm]Bild.south) {\includegraphics[scale=.39]{death_low}};
			\node (B5) at ([xshift=2.75cm]B4.east) {\includegraphics[scale=0.39]{death_inter}};
   			\node (B6) at ([xshift=2.75cm]B5.east) {\includegraphics[scale=.39]{death_high}};        	
			...
			\draw[thick,color=py_blue] (0.15,0.5) -- node[right=5pt] {\color{black} biostatic} (0.2,0.5);        	
			\draw[thick,color=py_orange] (0.15,0.4) -- node[right=5pt] {\color{black} biocidal} (0.2,0.4);    
			%\draw[thick,dashed] (0.15,0.6) -- node[right=5pt] {\color{black} mic$_S$} (0.2,0.6);  
			
			\node at ([xshift=-.3cm,yshift=1.6cm]Bild.center) {\small mic$_S$};   
